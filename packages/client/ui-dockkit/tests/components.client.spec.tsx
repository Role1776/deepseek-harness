...
import type { DockIntents } from '../src/model/adapter.ts'
import type { PaneId, TabId } from '../src/model/types.ts'
import { DockController } from '../src/model/controller.ts'
import { applyOp } from '../src/model/operations.ts'
import { FLOAT_DEFAULT_SIZE, FLOAT_MIN_SIZE } from '../src/model/constraints.ts'
import { floatRectAt } from '../src/model/geometry.ts'
import { DockSurface, type DockSurfaceProps } from '../src/components/DockSurface.tsx'
import type { TabMenuExtras } from '../src/model/adapter.ts'
import { FloatLayer, type FloatLayerProps } from '../src/components/FloatLayer.tsx'
import { dockPaneIds, getPane } from '../src/model/tree.ts'
