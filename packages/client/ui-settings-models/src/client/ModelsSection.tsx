...
import { protocolChoices, providerUsable } from '../model/store.ts'
import type { ModelsSettingsStore } from '../model/store.ts'
...
import {
  keyConfiguredOf, needsSetup, providerCopy, removeProviderProfile, targetOf,
  type EditorTarget, type ProviderIdentity,
} from '../model/section.ts'
...
/** The child slots this section declares and dispatches (see ../model/slots.ts). */
