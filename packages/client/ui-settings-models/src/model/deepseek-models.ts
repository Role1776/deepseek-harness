/**
 * Framework-free model catalogue helpers shared by the DeepSeek editor and the
 * pi-ai model list: capacity parsing/formatting and the adapter-side validation
 * the serialized schema cannot express.
 */
 ...
 * @returns one structurally open record per entry.
 */
