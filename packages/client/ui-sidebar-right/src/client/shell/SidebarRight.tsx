...
import { GUIDE_KIND, pageAddress } from '../../model/seed.ts'
import { dockLabels } from '../../model/labels.ts'
import type { SidebarRightOpenTabOptions } from '../../model/service.ts'
import type { SidebarRightTabDefinition } from '../../model/tab-registry.ts'
import type { createSidebarRightStore, SurfaceState } from '../../model/stores.ts'
import { canCloseTab } from '../../model/stores.ts'
import type { TabOccurrence } from '../../model/tab-domain.ts'
import type { SidebarRightTabNavigation, TabHookContext } from '../../model/slots.ts'
