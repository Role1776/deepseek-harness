...
import type { UseSidebarRightTabInfo } from '../src/model/slots.ts'
import { createSidebarRightStore } from '../src/model/stores.ts'
import { TabDomain, type TabOccurrence } from '../src/model/tab-domain.ts'
import { tabInfoFactory } from '../src/client/tab-info.ts'
import type { TabHookContext } from '../src/model/slots.ts'
