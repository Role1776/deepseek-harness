/** Workspace archive and directory UI capability: contract, error, and selection policy. */
 ...
 * @param workspaces - Workspace registry order.
 * @param sessions - Session summaries keyed by id.
 * @returns the Workspace with the most recent activity, or undefined when none exist.
 */
